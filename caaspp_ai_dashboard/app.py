...
SYSTEM_PREAMBLE = (
    ...
    "suspended statewide for COVID-19. 2025-26 isn't included yet either, since CDE doesn't "
    "release CAASPP results until October, after that school year's spring testing; it will "
    "be added once released. "
    "Achievement bands are Exceeded / Met / Nearly Met / "
